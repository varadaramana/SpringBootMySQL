...
public class CollegeController {
	...
	public CollegeDTO getCollegeDTO(@RequestParam("collegeId") String collegeId,
			@RequestParam("collegeName") String collegeName, @RequestParam("collegeLoc") String collegeLoc,
			@RequestParam("collegeDistrict") String collegeDistrict, @RequestParam("collegePh") String collegePh) {
		CollegeDTO clg = new CollegeDTO();
	...
	public CollegeDTO getCollegenoargs(@RequestParam("collegeId") String collegeId,
			@RequestParam("collegeName") String collegeName, @RequestParam("collegeLoc") String collegeLoc,
			@RequestParam("collegeDistrict") String collegeDistrict, @RequestParam("collegePh") String collegePh) {
		CollegeDTO clg = CollegeDTO.builder().collegeId(collegeId).collegeName(collegeName).collegeLoc(collegeLoc)
				.collegeDistrict(collegeDistrict).collegePh(collegePh).build();
	...
	public CollegeDTO getheadersargs(@RequestHeader("collegeId") String collegeId,
			@RequestHeader("collegeName") String collegeName, @RequestHeader("collageLoc") String collegeLoc,
			@RequestHeader("collegeDistrict") String collegeDistrict, @RequestHeader("collegePh") String collegePh) {
		return new CollegeDTO(collegeId, collegeName, collegeDistrict, collegeLoc, collegePh);
