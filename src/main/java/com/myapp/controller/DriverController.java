...
public class DriverController {
    ...
    public void deleteDriver(@Validated @PathVariable long driverId) throws EntityNotFoundException {
        driverService.delete(driverId);
    }


    @PutMapping("/{driverId}")
    public void updateLocation(@Validated @PathVariable long driverId, @RequestParam double longitude, @RequestParam double latitude)
            throws ConstraintsViolationException, EntityNotFoundException {
        driverService.updateLocation(driverId, longitude, latitude);
    }

    @PutMapping("/{driverId}/car/{licensePlate}")
    public void selectCar(@Validated @PathVariable long driverId, @PathVariable String licensePlate)
    ...
    public void deselectCar(@Validated @PathVariable long driverId, @PathVariable String licensePlate)
            throws ConstraintsViolationException, EntityNotFoundException, CarAlreadyInUseException {
